...
void clonestage1maker(Node* &head , Node* &tail , Node* &clonehead1 , Node* &clonetail1){
    Node* temp = head;
    while(temp != NULL){
        if(clonehead1 == NULL){
            clonehead1 = temp ;
...
void clonefinalstagemaker(Node* &head  , Node* &tail , Node* &clonehead , Node* &clonetail){
    Node* temp = head;
    Node* clonetemp = clonehead;
    while(clonetemp != NULL){
        int data = temp -> random -> data;
        Node* checker = clonehead;
        while(checker-> data != data){
            checker = checker-> next;
        }
        clonetemp-> random = checker;
...
int main(){
    ...
    clonestage1maker(head , tail , clonehead , clonetail) ;
    ...
    clonefinalstagemaker(head , tail , clonehead , clonetail);
